 ...
 *
 * Important:
 * Profile-side TOTP activation must not claim to protect the account until
 * the login flow also enforces the TOTP challenge.
 */
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      {
        ...
        message:
          "Die Zwei-Faktor-Einrichtung wurde gestartet.",
    ...
    console.error(
      "[PROFILE_TWO_FACTOR_SETUP_ROUTE_ERROR]",
      error,
    );
    ...
    return NextResponse.json(
      {
        ...
        message:
          "Die Zwei-Faktor-Einrichtung konnte gerade nicht gestartet werden.",
      },
      {
        status:
          500,
