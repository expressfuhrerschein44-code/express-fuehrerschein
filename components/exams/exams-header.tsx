...
export interface ExamsHeaderProps {
  status:
    ExamsPageStatus;
  licenseClassCode:
    string | null;
      ...
      <div className="flex flex-col gap-5 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between lg:p-7">
        <div className="min-w-0">
          ...
          <h1 className="mt-4 text-[24px] font-black tracking-[-0.03em] text-[#081529] sm:text-[28px]">
            {trainingOnly
              ? "Theorie unter Prüfungsbedingungen"
              : "Bereit für die Theorieprüfung?"}
          </h1>

          <p className="mt-2 max-w-[680px] text-[12px] font-medium leading-5 text-[#66758A] sm:text-[13px]">
            {trainingOnly
              ? "Trainiere konzentriert mit Zeitlimit und vollständiger Auswertung – ohne eine eigenständige offizielle Theorieprüfung vorzutäuschen."
              : "Simuliere eine vollständige Theorieprüfung mit deiner aktuellen Konfiguration, Zeitlimit und serverseitiger Auswertung."}
          </p>
        </div>
              ...
              "ready"
                ...
                : status ===
                  ...
                  : status ===
                    ...
                    ? "Kein Theorieprogramm"
                    : "Keine Prüfungskonfiguration"}
            </p>
          </div>
        </div>
      </div>
