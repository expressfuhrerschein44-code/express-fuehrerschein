...
export interface ErrorsHeaderProps {
  status:
    ErrorsPageStatus;
  licenseClassCode:
    string | null;
      ...
      <div className="flex flex-col gap-5 p-5 sm:p-6 lg:flex-row lg:items-center lg:justify-between lg:p-7">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-[#FFF2F2] px-3 py-1.5 text-[10px] font-extrabold text-[#C43737]">
              <CircleAlert
          ...
          <p className="mt-2 max-w-[680px] text-[12px] font-medium leading-5 text-[#66758A] sm:text-[13px]">
            Wiederhole gezielt Fragen, bei denen du noch unsicher bist, und festige dein Wissen Schritt für Schritt.
          </p>
        </div>
